...
{
    [HtmlTargetElement("pagerservice")]
    public class PagerServiceHelper : AnchorTagHelper
    {

        public PagerServiceHelper(IHtmlGenerator generator) : base(generator)
        {

        }

        public string PageParam { get; set; } = "pageindex";
        public WebServices.ViewModels.PagerViewModel Pager { get; set; }
